...
def getPacket(packNo, senderPack, receiverPack):
    ...
    if(packNo<=NumberOfPackets):
        print("Packet ",packNo,"is generated at time : ",totTime)
...
def GoBackN():
    ...
    while(1):
        ...
        if(checkList[receiverPacket][2]<=totTime+PacketGenTime and checkList[receiverPacket][2]!=0):
            print("\n\tPacket ",checkList[receiverPacket][0],"has been acknowledged. Time = ",checkList[receiverPacket][2])
            ...
            print("\n\tTimed out! Packet",checkList[receiverPacket][0],"hasn't been acknowledged. Time = ",checkList[receiverPacket][3])
